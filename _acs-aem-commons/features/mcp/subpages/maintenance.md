...
## Controller servlet
If you need additional control, the MCP servlet can be accesssed using REST calls.  It is tied to the main page resource with the "json" extension like so: `/apps/acs-commons/content/manage-controlled-processes/jcr:content.COMMAND.json`
