...
![JCR Compare - Configuration - Hosts](images/configuration-hosts.png)
...
![JCR Compare - Configuration - Paths](images/configuration-paths.png)
...
![JCR Compare - Configuration - Query](images/configuration-query.png)
...
![JCR Compare - Configuration - Node Types](images/configuration-node-types.png)
...
![JCR Compare - Configuration - Node Types to Exclude](images/configuration-node-types-to-exclude.png)
...
![JCR Compare - Configuration - Properties to Exclude](images/configuration-properties-to-exclude.png)
...
![JCR Compare - Configuration - Sorted Multi-value Properties](images/configuration-sort-properties.png)
...
![JCR Compare - Content Comparison](images/content-comparison.png)
...
![JCR Compare - Content Comparison - JSON Compare](images/content-comparison-json.png)
...
![JCR Compare - Downloads - JSON](images/download-json.png)
